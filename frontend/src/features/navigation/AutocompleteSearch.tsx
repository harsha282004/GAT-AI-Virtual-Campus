...
export function AutocompleteSearch() {
  ...
  return (
    <div className="relative w-full max-w-md">
      <div className="flex items-center gap-2 rounded-full border border-hairline bg-white px-4 py-2.5 shadow-soft transition-shadow duration-300 focus-within:border-brand/40 focus-within:shadow-glow dark:bg-[#0F172A] dark:shadow-black/30">
