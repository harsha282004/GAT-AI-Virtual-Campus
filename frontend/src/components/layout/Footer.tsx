    ...
    <footer className="relative bg-[#16213E] text-white/75">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/65">
            <li className="flex gap-2.5">
              ...
              <span>{t("Rajarajeshwari Nagar, Bangalore, Karnataka")}</span>
            </li>
            <li className="flex gap-2.5">
              <Phone className="h-4 w-4 shrink-0 text-white/40" />
              <span>{t("Campus buses from Majestic, Shivajinagar, Kengeri, Jayanagar")}</span>
            </li>
            <li className="flex gap-2.5">
      ...
      <div className="border-t border-white/10">
        <div className="container-page flex flex-col items-center justify-between gap-2 px-6 py-6 text-xs text-white/40 sm:flex-row sm:px-10 lg:px-16">
          <p>
            © {year} Global Academy of Technology. {t("All rights reserved.")}
          </p>
          <p>{t("Built as an AI Agent-Based Indoor Virtual Campus Tour project.")}</p>
        </div>
      </div>
    </footer>
  );
